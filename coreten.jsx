...
<div>
<aside className="fixed overflow-hidden left-0 top-0 z-10 h-screen w-[calc(3.37rem)] border-r border-gray-300/40 bg-white dark:bg-gray-900 dark:border-gray-700 hover:w-56 hover:shadow-2xl">
<div className="flex flex-col justify-between">
    <div>
        ...
        <div className="mt-6">
            <ul className="px-1 -ml-py font-medium tracking-wide">
                <li className="w-max space-y-4 group-hover:w-full">
                    <a
                        href=""
                        className="block py-3 w-[52px] rounded-full bg-sky-500 group-hover:w-full"
                    >
                ...
                <li>
                    <a href="">
                        <div className="flex items-center gap-4 px-4 py-3">
                            <span className="text-gray-600 dark:gray-300"></span>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5"
                                viewBox="0 0 20 20"
...
<main className="w-[calc(100%-3.37rem)] ml-auto">
<div className="2xl:container mx-auto space-y-6">
    ...
    <div className="px-6 lg:px-12">
        <div className="h-96 flex justify-center items-center rounded-2xl border border-dashed border-gray-300/40 dark:border-gray-700">
            <span className="text-gray dark:text-gray-200">
                Content
            </span>
        </div>
    </div>
