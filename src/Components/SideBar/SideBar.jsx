                ...
                <div className="h-full flex flex-col justify-between">
                    <div className="">
                        <div className="h-16 border-b border-gray-300/40 flex items-center">
                            <a href="" className="block w-max px-2.5 flex items-center gap-3 text-color-1 text-l font-bold">
                            <img src="/image/Lucy_Sky-removebg-preview.png" class="h-10" alt=""/>
                            <span>TOKO ALKOHOL</span>
                            </a>
                        </div>
                        <div className="mt-6">
